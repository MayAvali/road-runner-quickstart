...
//
        ...
        GamepadButton PinpointReset = new GamepadButton(gamepad1, GamepadButton.gamepadKeys.SHARE);
        GamepadButton TargetReset = new GamepadButton(gamepad1, GamepadButton.gamepadKeys.START);
...
//            doTelemetry( // i LLLOVVVEEEEE artifacts, but i cant have any or else i'll get FAT
//                    telemetry,
//                    dashboardTelemetry,
//                    drivetrain,
//                    scoringsystem,
...
//            );
    ...
    private void doTelemetry(
        ...
        publishTelemetry(state, drivetrain, scoringSystem, TargetPose, data, velocity, frequency);
    }
    ...
    private void publishTelemetry(TeleOpCompetitionRed.RobotState robotState, MecanumDrive drivetrain, ScoringSystem scoringsystem, Pose2D TargetPose, String data, String velocity, double frequency) {
