...
@Autonomous(name = "9. Autonomous RED Goal Unique", group = "Autonomous OpMode")
public class RedAutoUnique extends LinearOpMode {
    @Override
    public void runOpMode() throws InterruptedException {
        ...
        final Pose2d PreScorePosition = AutoMap.RedPreScorePosition;

        final Pose2d ScorePosition = AutoMap.RedScorePosition;

        final Pose2d CollectAlign = AutoMap.RedCollectAlign;

        final Pose2d PPGAlign = AutoMap.RedPPGAlign;

        final Pose2d PPGGrab = AutoMap.RedPPGGrab;

        final Pose2d PGPAlign = AutoMap.RedPGPAlign;

        final Pose2d PGPGrab = AutoMap.RedPGPGrab;

        final Pose2d GPPAlign = AutoMap.RedGPPAlign;

        final Pose2d GPPGrab = AutoMap.RedGPPGrab;

        final Pose2d GatePark = AutoMap.RedGatePark;

        final Pose2d GateIntake = AutoMap.RedGateIntake;

        final Pose2d GateIntake2 = AutoMap.RedGateIntake2;

        final Pose2d GateLeave = AutoMap.RedGateLeave;
